...
def policy_v5():
    policy = [
        [('Posterize', 0.2, 2), ('TranslateX_BBox', 0, 8)],
        [('BBox_Cutout', 0.8, 10), ('Sharpness', 0, 8)],
        [('Rotate_BBox', 0.4, 8), ('Rotate_BBox', 0.2, 10)],
        [('Equalize', 0.2, 8), ('AutoContrast', 0.8, 10)],
        [('SolarizeAdd', 0.8, 2), ('TranslateY_BBox', 0.8, 8)],
        [('Sharpness', 1, 2), ('Color', 0.6, 8)],
        [('Equalize', 0, 8), ('TranslateX_Only_BBoxes', 0, 8)],
        [('Posterize', 0.4, 2), ('Rotate_BBox', 1, 10)],
        [('AutoContrast', 0.4, 0), ('Rotate_BBox', 0, 6)],
        [('Equalize', 1, 8), ('BBox_Cutout', 0.2, 10)],
        [('Brightness', 0, 2), ('TranslateY_Only_BBoxes', 0, 6)],
        [('Contrast', 1, 2), ('ShearY_BBox', 0.2, 0)],
        [('AutoContrast', 0.2, 10), ('Contrast', 0.8, 10)],
        [('Rotate_BBox', 0, 10), ('BBox_Cutout', 0, 10)],
        [('SolarizeAdd', 0.2, 6), ('Equalize', 0.2, 8)]      
    ]
    return policy
